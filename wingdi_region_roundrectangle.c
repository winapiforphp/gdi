...
static zend_class_entry     *ce_wingdi_round_region;
...
static zend_object_value wingdi_region_rounded_new (zend_class_entry * ce TSRMLS_DC)
{
...
{
    if (Z_OBJCE_P(object) == ce_wingdi_round_region)
    {
...
PHP_MINIT_FUNCTION(wingdi_region_roundedrectangle)
{
    ...
    ce_wingdi_round_region->create_object = wingdi_region_rounded_new;
    ...
    ctor_wrapper_func.common.scope         = ce_wingdi_round_region;
